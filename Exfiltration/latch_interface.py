...
try:
	...
	print('Error, no constant.py file detected, please create one with the given constants')
	sys.exit(0)
...
class LatchInterface(object):
    ...
    def __init__(self, account_id = None):
        self.account_id = constants.ACCOUNT_ID
        self.latch_app_id = constants.APP_ID
        self.latch_app_secret = constants.APP_SECRET
